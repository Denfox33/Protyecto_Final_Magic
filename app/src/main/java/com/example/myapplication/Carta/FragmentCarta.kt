...
import com.example.myapplication.databinding.FragmentCartaBinding
 ...
 */
class FragmentCarta : Fragment() {
    private lateinit var bind: FragmentCartaBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        bind = FragmentCartaBinding.inflate(layoutInflater)
        ...
        db_ref.child("Tienda").child("Cartas").addValueEventListener(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                snapshot.children.forEach { hijo: DataSnapshot? ->
                    ...
                    // Verificar la disponibilidad de la carta antes de agregarla a la lista
                    if (pojocarta?.disponibilidad == "Si") {
                        lista.add(pojocarta)
                    }
                }
